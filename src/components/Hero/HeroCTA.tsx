    ...
    <div className="relative z-40 mt-20 grid grid-cols-1 lg:grid-cols-3 xl:mx-auto xl:max-w-[1440px]">
      <div className="grid grid-cols-1 items-center justify-center gap-4 px-2 lg:gap-2 lg:pl-10 xl:pl-0">
        <div className="mx-auto h-10 w-full rounded-full bg-purple-800 lg:mx-0 lg:h-12 xl:h-14 xl:w-96">
          <div className="flex h-full w-full items-center justify-center rounded-full bg-gradient-to-b from-white/40 to-[#2F2D2D]/20 px-2 py-0 text-sm text-white/80 lg:px-10 lg:py-1 lg:text-base xl:px-6 xl:py-2 xl:text-lg">
            Junior Full-Stack Engineer
          </div>
        </div>
        <div
          className="text-center text-[60vw] font-bold leading-[11vw] lg:text-left lg:text-[4vw] lg:leading-[5vw] xl:text-[4.5vw] xl:leading-tight
           bg-gradient-to-b to-[#251193] from-[#FFF4F4] bg-clip-text text-transparent"
        >
